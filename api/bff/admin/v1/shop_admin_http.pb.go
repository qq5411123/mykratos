...
func _ShopAdmin_Login0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/Login")
...
func _ShopAdmin_Logout0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/Logout")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_ListBeer0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/ListBeer")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_CreateBeer0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/CreateBeer")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_UpdateBeer0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/UpdateBeer")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_DeleteBeer0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/DeleteBeer")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_ListOrder0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/ListOrder")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_GetOrder0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/GetOrder")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_ListUser0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/ListUser")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopAdmin_GetUser0_HTTP_Handler(srv ShopAdminHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/bff.admin.v1.ShopAdmin/GetUser")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ShopAdminHTTPClientImpl) CreateBeer(ctx context.Context, in *CreateBeerReq, opts ...http.CallOption) (*CreateBeerReply, error) {
	...
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/CreateBeer"))
...
func (c *ShopAdminHTTPClientImpl) DeleteBeer(ctx context.Context, in *DeleteBeerReq, opts ...http.CallOption) (*DeleteBeerReply, error) {
	...
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/DeleteBeer"))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *ShopAdminHTTPClientImpl) GetOrder(ctx context.Context, in *GetOrderReq, opts ...http.CallOption) (*GetOrderReply, error) {
	...
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/GetOrder"))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *ShopAdminHTTPClientImpl) GetUser(ctx context.Context, in *GetUserReq, opts ...http.CallOption) (*GetUserReply, error) {
	...
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/GetUser"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopAdminHTTPClientImpl) ListBeer(ctx context.Context, in *ListBeerReq, opts ...http.CallOption) (*ListBeerReply, error) {
	...
	pattern := "/admin/v1/catalog/beers"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/ListBeer"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopAdminHTTPClientImpl) ListOrder(ctx context.Context, in *ListOrderReq, opts ...http.CallOption) (*ListOrderReply, error) {
	...
	pattern := "/admin/v1/orders"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/ListOrder"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopAdminHTTPClientImpl) ListUser(ctx context.Context, in *ListUserReq, opts ...http.CallOption) (*ListUserReply, error) {
	...
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/ListUser"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopAdminHTTPClientImpl) Login(ctx context.Context, in *LoginReq, opts ...http.CallOption) (*LoginReply, error) {
	...
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/Login"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopAdminHTTPClientImpl) Logout(ctx context.Context, in *LogoutReq, opts ...http.CallOption) (*LogoutReply, error) {
	...
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/Logout"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopAdminHTTPClientImpl) UpdateBeer(ctx context.Context, in *UpdateBeerReq, opts ...http.CallOption) (*UpdateBeerReply, error) {
	...
	pattern := "/admin/v1/catalog/beers/{id}"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/bff.admin.v1.ShopAdmin/UpdateBeer"))
	opts = append(opts, http.PathTemplate(pattern))

...
var file_v1_shop_admin_proto_goTypes = []interface{}{
	(*RegisterReq)(nil),              // 0: bff.admin.v1.RegisterReq
	(*RegisterReply)(nil),            // 1: bff.admin.v1.RegisterReply
	(*LoginReq)(nil),                 // 2: bff.admin.v1.LoginReq
	(*LoginReply)(nil),               // 3: bff.admin.v1.LoginReply
	(*LogoutReq)(nil),                // 4: bff.admin.v1.LogoutReq
	(*LogoutReply)(nil),              // 5: bff.admin.v1.LogoutReply
	(*GetUserReq)(nil),               // 6: bff.admin.v1.GetUserReq
	(*GetUserReply)(nil),             // 7: bff.admin.v1.GetUserReply
	(*ListUserReq)(nil),              // 8: bff.admin.v1.ListUserReq
	(*ListUserReply)(nil),            // 9: bff.admin.v1.ListUserReply
	(*CreateUserReq)(nil),            // 10: bff.admin.v1.CreateUserReq
	(*CreateUserReply)(nil),          // 11: bff.admin.v1.CreateUserReply
	(*VerifyPasswordReq)(nil),        // 12: bff.admin.v1.VerifyPasswordReq
	(*VerifyPasswordReply)(nil),      // 13: bff.admin.v1.VerifyPasswordReply
	(*ListAddressReq)(nil),           // 14: bff.admin.v1.ListAddressReq
	(*ListAddressReply)(nil),         // 15: bff.admin.v1.ListAddressReply
	(*CreateAddressReq)(nil),         // 16: bff.admin.v1.CreateAddressReq
	(*CreateAddressReply)(nil),       // 17: bff.admin.v1.CreateAddressReply
	(*GetAddressReq)(nil),            // 18: bff.admin.v1.GetAddressReq
	(*GetAddressReply)(nil),          // 19: bff.admin.v1.GetAddressReply
	(*ListCardReq)(nil),              // 20: bff.admin.v1.ListCardReq
	(*ListCardReply)(nil),            // 21: bff.admin.v1.ListCardReply
	(*CreateCardReq)(nil),            // 22: bff.admin.v1.CreateCardReq
	(*CreateCardReply)(nil),          // 23: bff.admin.v1.CreateCardReply
	(*GetCardReq)(nil),               // 24: bff.admin.v1.GetCardReq
	(*GetCardReply)(nil),             // 25: bff.admin.v1.GetCardReply
	(*DeleteCardReq)(nil),            // 26: bff.admin.v1.DeleteCardReq
	(*DeleteCardReply)(nil),          // 27: bff.admin.v1.DeleteCardReply
	(*ListBeerReq)(nil),              // 28: bff.admin.v1.ListBeerReq
	(*ListBeerReply)(nil),            // 29: bff.admin.v1.ListBeerReply
	(*GetBeerReq)(nil),               // 30: bff.admin.v1.GetBeerReq
	(*GetBeerReply)(nil),             // 31: bff.admin.v1.GetBeerReply
	(*ListCartItemReq)(nil),          // 32: bff.admin.v1.ListCartItemReq
	(*ListCartItemReply)(nil),        // 33: bff.admin.v1.ListCartItemReply
	(*AddCartItemReq)(nil),           // 34: bff.admin.v1.AddCartItemReq
	(*AddCartItemReply)(nil),         // 35: bff.admin.v1.AddCartItemReply
	(*CreateOrderReq)(nil),           // 36: bff.admin.v1.CreateOrderReq
	(*CreateOrderReply)(nil),         // 37: bff.admin.v1.CreateOrderReply
	(*ListOrderReq)(nil),             // 38: bff.admin.v1.ListOrderReq
	(*ListOrderReply)(nil),           // 39: bff.admin.v1.ListOrderReply
	(*GetOrderReq)(nil),              // 40: bff.admin.v1.GetOrderReq
	(*GetOrderReply)(nil),            // 41: bff.admin.v1.GetOrderReply
	(*CreateBeerReq)(nil),            // 42: bff.admin.v1.CreateBeerReq
	(*CreateBeerReply)(nil),          // 43: bff.admin.v1.CreateBeerReply
	(*UpdateBeerReq)(nil),            // 44: bff.admin.v1.UpdateBeerReq
	(*UpdateBeerReply)(nil),          // 45: bff.admin.v1.UpdateBeerReply
	(*DeleteBeerReq)(nil),            // 46: bff.admin.v1.DeleteBeerReq
	(*DeleteBeerReply)(nil),          // 47: bff.admin.v1.DeleteBeerReply
	(*ListAddressReply_Address)(nil), // 48: bff.admin.v1.ListAddressReply.Address
	(*ListCardReply_Card)(nil),       // 49: bff.admin.v1.ListCardReply.Card
	(*ListBeerReply_Beer)(nil),       // 50: bff.admin.v1.ListBeerReply.Beer
	(*ListBeerReply_Beer_Image)(nil), // 51: bff.admin.v1.ListBeerReply.Beer.Image
	(*GetBeerReply_Image)(nil),       // 52: bff.admin.v1.GetBeerReply.Image
	(*CreateBeerReq_Image)(nil),      // 53: bff.admin.v1.CreateBeerReq.Image
	(*UpdateBeerReq_Image)(nil),      // 54: bff.admin.v1.UpdateBeerReq.Image
}
var file_v1_shop_admin_proto_depIdxs = []int32{
	48, // 0: bff.admin.v1.ListAddressReply.results:type_name -> bff.admin.v1.ListAddressReply.Address
	49, // 1: bff.admin.v1.ListCardReply.results:type_name -> bff.admin.v1.ListCardReply.Card
	50, // 2: bff.admin.v1.ListBeerReply.results:type_name -> bff.admin.v1.ListBeerReply.Beer
	52, // 3: bff.admin.v1.GetBeerReply.image:type_name -> bff.admin.v1.GetBeerReply.Image
	53, // 4: bff.admin.v1.CreateBeerReq.image:type_name -> bff.admin.v1.CreateBeerReq.Image
	54, // 5: bff.admin.v1.UpdateBeerReq.image:type_name -> bff.admin.v1.UpdateBeerReq.Image
	51, // 6: bff.admin.v1.ListBeerReply.Beer.image:type_name -> bff.admin.v1.ListBeerReply.Beer.Image
	2,  // 7: bff.admin.v1.ShopAdmin.Login:input_type -> bff.admin.v1.LoginReq
	4,  // 8: bff.admin.v1.ShopAdmin.Logout:input_type -> bff.admin.v1.LogoutReq
	28, // 9: bff.admin.v1.ShopAdmin.ListBeer:input_type -> bff.admin.v1.ListBeerReq
	42, // 10: bff.admin.v1.ShopAdmin.CreateBeer:input_type -> bff.admin.v1.CreateBeerReq
	44, // 11: bff.admin.v1.ShopAdmin.UpdateBeer:input_type -> bff.admin.v1.UpdateBeerReq
	46, // 12: bff.admin.v1.ShopAdmin.DeleteBeer:input_type -> bff.admin.v1.DeleteBeerReq
	38, // 13: bff.admin.v1.ShopAdmin.ListOrder:input_type -> bff.admin.v1.ListOrderReq
	40, // 14: bff.admin.v1.ShopAdmin.GetOrder:input_type -> bff.admin.v1.GetOrderReq
	8,  // 15: bff.admin.v1.ShopAdmin.ListUser:input_type -> bff.admin.v1.ListUserReq
	6,  // 16: bff.admin.v1.ShopAdmin.GetUser:input_type -> bff.admin.v1.GetUserReq
	3,  // 17: bff.admin.v1.ShopAdmin.Login:output_type -> bff.admin.v1.LoginReply
	5,  // 18: bff.admin.v1.ShopAdmin.Logout:output_type -> bff.admin.v1.LogoutReply
	29, // 19: bff.admin.v1.ShopAdmin.ListBeer:output_type -> bff.admin.v1.ListBeerReply
	43, // 20: bff.admin.v1.ShopAdmin.CreateBeer:output_type -> bff.admin.v1.CreateBeerReply
	45, // 21: bff.admin.v1.ShopAdmin.UpdateBeer:output_type -> bff.admin.v1.UpdateBeerReply
	47, // 22: bff.admin.v1.ShopAdmin.DeleteBeer:output_type -> bff.admin.v1.DeleteBeerReply
	39, // 23: bff.admin.v1.ShopAdmin.ListOrder:output_type -> bff.admin.v1.ListOrderReply
	41, // 24: bff.admin.v1.ShopAdmin.GetOrder:output_type -> bff.admin.v1.GetOrderReply
	9,  // 25: bff.admin.v1.ShopAdmin.ListUser:output_type -> bff.admin.v1.ListUserReply
	7,  // 26: bff.admin.v1.ShopAdmin.GetUser:output_type -> bff.admin.v1.GetUserReply
